...
Modern running calculator with four features:
...
4. 400m track simulator: lane view, split markers, animated runner, and custom target distance with smart split checkpoints.
